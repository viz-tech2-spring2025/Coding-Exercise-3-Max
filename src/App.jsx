...
const sfZipCodes = [
  "94112", "94110", "94122", "94109", "94116", "94117", "94118", "94121",
  "94134", "94175", "94124", "94114", "94102", "94115", "94103", "94167",
  "94131", "94132", "94107", "94138", "94165", "94133", "94166", "94123",
  "94106", "94150", "94152", "94127", "94168", "94170", "94105", "94135",
  "94108", "94169", "94158", "94136", "94155", "94111", "94129", "94130",
  "94104", "94101", "94153", "94154", "94156", "94162", "94171", "94199",
  "94157", "94119", "94120", "94126", "94137", "94139", "94141", "94140",
  "94143", "94142", "94145", "94144", "94147", "94146", "94151", "94159",
  "94161", "94160", "94163", "94164", "94172", "94188", "94177"
];
...
const Scrollytelling = () => {
  ...
  const [refHonoluluSection, inViewHonoluluSection] = useInView({ threshold: 0.5 });
  ...
  useEffect(() => {
    ...
    const filteredDenver = coZip.features
      .filter(feature => denverZipCodes.includes(feature.properties.ZCTA5CE10))
      .map(assignManualValue);
    const filteredHonolulu = hiZip.features
      .filter(feature => honoluluZipCodes.includes(feature.properties.ZCTA5CE10))
      .map(assignManualValue);
    ...
    <div className="scrollytelling-container">
      <div ref={textColumnRef} className="text-column">
        <section ref={refSFSection} className="text-section">
          <h1>San Francisco</h1>
          <p>San Francisco’s iconic cool fog and temperate coastal vibes are giving way to noticeably warmer days. As you can see here, the temperature gradients have shifted, revealing a trend towards higher daytime averages. This evolution in the climate not only transforms the city’s microclimate but also invites a fresh perspective on urban living in a warming coastal environment.

</p>
        </section>
        <section ref={refDenverSection} className="text-section">
          <h1>Denver</h1>
          <p>Denver, famous for its clear skies and crisp mountain air, is experiencing a steady climb in temperatures. The map illustrates a warming trend across various neighborhoods, echoing a broader change in the city’s high-altitude climate. This gradual increase in heat is reshaping local lifestyles and prompting discussions on how best to adapt to a warmer future.

</p>
        </section>
        <section ref={refHonoluluSection} className="text-section">
          <h1>Honolulu</h1>
          <p>Even in the tropical paradise of Honolulu, familiar warm days are intensifying. In this map of the city, subtle but consistent increases in temperature mark a shift in a climate that has long been a hallmark of island life. This warming trend not only affects daily comfort but also serves as a reminder of the evolving environmental challenges facing even the most idyllic destinations.</p>
        </section>
      </div>
